...
angular.module('application').controller('MusicCtrl', function($scope) { //player audio
    $scope.tracks = [
        {
...
console.log(newPath);
  ...
  $scope.checkDir = function () {
    document.addEventListener('deviceready', function () {
      // path, directory
      $cordovaFile.checkDir(cordova.file.dataDirectory, "sdcard", $scope.inputs.checkDir).then(function (success) {
